...
class Config(ABC):
    def __init__(self):
        ...
        self.topk = args.topk
        self.data_no_norm = args.data_no_norm
        self.llm_input_options = args.llm_input_options
        self.sort_type = args.sort_type
        self.passes = args.passes
        self.topk_retrieval_method = args.topk_retrieval_method

...
from model.vlm2vec_src.utils import print_master

from model.vlm2vec_src.vlm_backbone.llava_next import LlavaNextForConditionalGeneration
from model.vlm2vec_src.vlm_backbone.phi3_v.modeling_phi3_v import Phi3VForCausalLM
from model.vlm2vec_src.vlm_backbone.qwen2_5_vl import Qwen2_5_VLForConditionalGeneration
from model.vlm2vec_src.vlm_backbone.qwen2_vl import Qwen2VLForConditionalGeneration
...
def load_processor(model_args):
    ...
    if model_args.model_backbone == PHI3V:
        from model.vlm2vec_src.vlm_backbone.phi3_v.processing_phi3_v import Phi3VProcessor
        ...
        from model.vlm2vec_src.vlm_backbone.qwen2_vl.processing_qwen2_vl import Qwen2VLProcessor
        from model.vlm2vec_src.vlm_backbone.qwen2_vl.image_processing_qwen2_vl import Qwen2VLImageProcessor
        from model.vlm2vec_src.vlm_backbone.qwen2_vl.tokenization_qwen2_fast import Qwen2TokenizerFast
        ...
        from model.vlm2vec_src.vlm_backbone.qwen2_5_vl.processing_qwen2_5_vl import Qwen2_5_VLProcessor
        from model.vlm2vec_src.vlm_backbone.qwen2_5_vl.image_processing_qwen2_5_vl import Qwen2_5_VLImageProcessor
        from model.vlm2vec_src.vlm_backbone.qwen2_vl.tokenization_qwen2_fast import Qwen2TokenizerFast
